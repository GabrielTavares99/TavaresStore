<?php 
	...
	listaProduto($conexao){
		$produtos = array();
		$consulta = mysqli_query($conexao,"SELECT p.*,c.nome AS categoria_nome FROM tb_produtos AS p JOIN tb_categorias AS c ON p.categoria_id = c.id Order BY p.id DESC");
	...
	function insereProduto($conexao, $nome, $preco, $descricao, $categoria_id, $usado){
		...
		$query = "INSERT INTO tb_produtos (nome,preco,descricao,categoria_id,usado) 
